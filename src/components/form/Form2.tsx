        ...
        <div className={`w-full  mx-auto mt-5 absolute space-y-4 transition-all transition-discrete duration-2000
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        type="text"
                        className="mt-1 w-full bg-white h-11 rounded-md border border-[#40E1D1] px-3 outline-none"
                    />
                </div>
            ...
            <div >
                ...
                <div className="mt-1 flex h-11 rounded-md border bg-white border-[#40E1D1] overflow-hidden py-3">
